void vector_addition_set_reg_store{
  int i = 0
  ...
  for (int r = 0; r < 10; r++){
    /*003*/INSTR_opcode[i] = STORE_VALUE; INSTR_operandres[i] = 10; INSTR_operand1[i] = 10; INSTR_operand2[i] = 0; i++;
    /*004*/INSTR_opcode[i] = STORE_VALUE; INSTR_operandres[i] = 11; INSTR_operand1[i] = 15; INSTR_operand2[i] = 0; i++;
